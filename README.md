...
The form *Luhtala* has then eventually become established as the official family name. It is possible that before the surname *Luhtala* was adopted, my Orthodox Karelian ancestors did not have a surname. Instead, they used patronyms (patronym: a part of a person's name is based on their father's first name).
